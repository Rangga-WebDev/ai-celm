      ...
      <div className="flex items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-1 truncate text-xs text-slate-500 sm:text-sm">
              Modules · Micro-Units · Resources · CER · Forums · Projects
            </div>
          </div>
        </div>
        ...
        <div className="hidden min-w-0 max-w-xl flex-1 xl:flex xl:justify-center">
          <div className="flex w-full max-w-xl items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.045] px-4 py-3">
            ...
            <input
              type="text"
              placeholder="Cari course, modul, resource, CER, forum..."
        ...
        <WorkspaceUserMenu
          user={user}
          profileHref="/lecturer/dashboard"
          settingsHref="/lecturer/dashboard"
          roleLabel="Lecturer Session Active"
        />
      </div>
    </header>
  );
